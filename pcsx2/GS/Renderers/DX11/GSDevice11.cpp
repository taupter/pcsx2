...
void GSDevice11::SetFeatures(IDXGIAdapter1* adapter)
{
	...
	m_read_only_depth = (m_feature_level >= D3D_FEATURE_LEVEL_11_0);
	...
	Console.WriteLnFmt("D3D11: Read Only Depth: {}", m_read_only_depth ? "Supported" : "Not Supported");
